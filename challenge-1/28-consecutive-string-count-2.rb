...
def consecutive_string_count(string)
  ...
  # If the current character is not equal to the next character, create a new array
  # with the count of the number of items in the minor bag, and the identity of the last item
  # in the minor bag.
  # Populate the main bag with the contents
  # Set the minor bag to have the next character  
